...
<div class="container">
    ...
    <a href="{{ route('admin.students.edit', $student) }}" class="btn btn-warning">Düzenle</a>
    ...
    <hr>
    <a href="{{ route('admin.students.debts', $student) }}" class="btn btn-secondary">Borçları Görüntüle</a>
</div>
@endsection
